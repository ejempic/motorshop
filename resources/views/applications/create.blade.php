                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-append"> <button type="button" class="btn btn-primary">Add New
                                        </button>
                                    </span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="total_price" value="{{old('total_price')}}" name="total_price"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="down_payment" value="{{old('down_payment')}}" name="down_payment"
                                                   class="form-control money" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled id="total_less_downpayment"
                                                   value="{{old('total_less_downpayment')}}" name="total_less_downpayment" class="form-control money" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="months" value="{{old('months')}}" name="months" class="form-control"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled id="years" value="{{old('years')}}" name="years"
                                                   class="form-control money" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled id="gross_monthly_rate"
                                                   value="{{old('gross_monthly_rate')}}" name="gross_monthly_rate"
                                                   class="form-control money" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="rebate" value="{{old('rebate')}}" name="rebate" class="form-control money"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled id="net_monthly_rate" value="{{old('net_monthly_rate')}}" name="net_monthly_rate"
                                                   class="form-control money" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first_payment_due" value="{{old('first_payment_due')}}" name="first_payment_due"
                                                   class="form-control money" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first_due_date" value="{{old('first_due_date')}}" name="first_due_date"
